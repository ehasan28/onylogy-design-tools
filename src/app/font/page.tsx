...
import { TypographyWorkspace } from "@/components/typography/TypographyWorkspace";
import { TOOLS } from "@/lib/seo/tool-meta";

export const metadata: Metadata = {
  title: "Font Workspace — Pairings, Scales, Clamp, Exports",
  description:
    "Build a complete typography system for WordPress, Kadence, Gutenberg, or Tailwind. Curated font pairings, modular scales, clamp() responsive sizing, and one-click exports.",
  alternates: { canonical: "/font" },
};

export default function FontHubPage() {
  const fontTools = TOOLS.filter((t) => t.category === "font");
  return (
    <>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="mt-3 max-w-3xl text-base text-fg-muted">
                Curated pairings, modular scales, responsive clamp() systems,
                readability analysis, and exports. Built for WordPress,
                Kadence, Gutenberg, and Tailwind creators.
              </p>
            </div>
          </div>
        </div>
